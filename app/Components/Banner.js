  ...
  return (
    ...
    <div className="banner w-[100%] h-[21vh] relative bg-[url('/images/background.svg')] flex items-center px-9 justify-between max-mb:h-[15vh] max-mb:px-5 max-mb:justify-center">
        ...
        <div className='max-mb:hidden'>
          <a href="https://www.linkedin.com/in/jay-pokharna-940a42207" className='flex gap-2 items-center text-sm w-fit bg-[rgb(20,19,25)] py-2 px-4 rounded-md brightness-50 hover:brightness-90  cursor-pointer'>
