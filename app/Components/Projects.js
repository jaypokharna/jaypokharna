...
const Projects = () => {
  return (
    <>
    <div className="projects relative py-6 px-[4%] w-full flex flex-col gap-8 max-mb:h-auto max-mb:gap-0">

        <div className='text-xl font-semibold max-mb:text-center max-mb:pb-6'>Projects</div>

        <div className='cards flex gap-4 justify-between h-[240px] max-mb:flex-col max-mb:h-auto'>
